...
const Hero = () => {
    return (
        <section class="flex flex-col items-center text-white text-sm pb-20">
            <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/refs/heads/main/assets/hero/bg-gradient-2.png" class="absolute inset-0 -z-10 size-full opacity" alt="" />

            <nav class="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur border-b border-slate-800">
                ...
                <div class="hidden md:block space-x-3">
                    <button class="active:scale-95 hover:bg-indigo-600/20 transition px-4 py-2 border border-indigo-600 rounded-md">
                        Sign in
                    </button>
                    <button class="px-6 py-2 bg-indigo-600 active:scale-95 hover:bg-indigo-700 transition rounded-md">
                        Get started
                    </button>
                </div>
            ...
            <div id="mobile-navLinks" class="fixed inset-0 z-[100] bg-black/60 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 -translate-x-full">
                <a href="#products" onclick="closeMenuHandler()">
                    Products
                </a>
                <a href="#resources" onclick="closeMenuHandler()">
                    Resources
                </a>
                <a href="#stories" onclick="closeMenuHandler()">
                    Stories
                </a>
                <a href="#pricing" onclick="closeMenuHandler()">
                    Pricing
                </a>
            ...
            <h1 class="text-center text-[40px] leading-[48px] md:text-6xl md:leading-[70px] mt-4 font-semibold max-w-3xl">
                Turn thoughts into slides instantly, with AI.
            </h1>
            <p class="text-center text-base max-w-md mt-2">
            ...
            <div class="bg-white/10 max-w-2xl w-full rounded-xl p-4 mt-10 border border-indigo-600/70">
                <textarea class="bg-transparent outline-none text-gray-300 resize-none w-full" rows="4" placeholder="Describe your presentation in details"></textarea>
                <button class="ml-auto flex items-center gap-2 bg-gradient-to-r from-[#CB52D4] to-indigo-600 rounded-md px-4 py-2">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#a)" stroke="#F8FAFC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="flex flex-wrap items-center justify-center gap-16 md:gap-20 mx-auto mt-16">
                <img class="max-w-28 md:max-w-32" src="https://saasly.prebuiltui.com/assets/companies-logo/framer.svg" alt="">
                    <img class="max-w-28 md:max-w-32" src="https://saasly.prebuiltui.com/assets/companies-logo/huawei.svg" alt="">
                        <img class="max-w-28 md:max-w-32" src="https://saasly.prebuiltui.com/assets/companies-logo/instagram.svg" alt="">
                            <img class="max-w-28 md:max-w-32" src="https://saasly.prebuiltui.com/assets/companies-logo/microsoft.svg" alt="">
                                <img class="max-w-28 md:max-w-32" src="https://saasly.prebuiltui.com/assets/companies-logo/walmart.svg" alt="">
                                </div>
                            </section>
}
}
