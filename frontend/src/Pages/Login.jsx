  ...
  return (
    ...
    <div className='text-center md:text-left mt-12'>
        ...
        <p className='text-sm/6 text-white max-w-[345px] mt-4 mx-auto md:mx-0'>Login & Turn your PDFs into clear summaries and answer with AI-powered DocuBrain</p> 
                <button onClick={()=>navigate("/login")}>Dont have an Account? SignUp</button>
    </div>
        ...
        <form className='space-y-6'>
            ...
            <div className='flex items-center justify-between'>
                <p className='text-xs md:text-sm text-white/60 max-w-3xs'>
                    By submitting, you agree to our <span className='text-white'>Terms</span> and <span class='text-white'>Privacy Policy</span>.
                </p>
